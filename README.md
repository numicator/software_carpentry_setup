...
"snow-leopard" [available here](http://sourceforge.net/projects/git-osx-installer/files/).
...
5.  Type
6.  bash "Anaconda3-" (without quotations) and then press <TAB>. The name of the file you just downloaded should appear.
7.  Press enter. You will follow the text-only prompts. When there is a
